...
VALUES (1, '1HGBH41JXMN109186', 'Red', TRUE, 'RENTED', '2025-01-01'),
...
(
    ...
    fk_vehicle_id INT DEFAULT NULL,
...
VALUES (1, 'Demo', 'Kunde', 'demo@kunde.dk', 87654321, 'Gadevej 17', 'Herning', 7000, '123456-1234'),
       ...
       (5, 'Freja', 'Andersen', 'freja.andersen@example.com', 33334444, 'Pine Rd 9', 'Esbjerg', 6700, '505903-5678'),
       (6, 'Lucas', 'Christensen', 'lucas.christensen@example.com', 44445555, 'Maple St 11', 'Randers', 8900,
        '606910-6789'),
       (7, 'Ida', 'Jensen', 'ida.jensen@example.com', 55556666, 'Fir Ln 13', 'Horsens', 8700, '707903-7890'),
       (8, 'Noah', 'Madsen', 'noah.madsen@example.com', 66667777, 'Cedar Blvd 15', 'Kolding', 6000, '808901-8901'),
       (9, 'Clara', 'Thomsen', 'clara.thomsen@example.com', 77778888, 'Spruce Dr 17', 'Vejle', 7100, '909904-9012'),
       (10, 'Oscar', 'Poulsen', 'oscar.poulsen@example.com', 88889999, 'Ash Ct 19', 'Herning', 7400, '101091-0123');
...
INSERT INTO lease_agreement(lease_agreement_id, fk_vehicle_id, fk_customer_id, lease_type, lease_start_date,
                            lease_end_date, lease_price, return_location, lease_active)
VALUES (1, 1, 1, 'UNLIMITED', '2025-01-01', '2025-05-01', 10000.00, 'Guldgade', true),
...
INSERT INTO condition_report(fk_vehicle_id, handled_by, report_start_date, report_completed_date, excess_kilometers,
                             completed, report_description)
VALUES (1, 'JÜHIN', '2025-05-08', '2025-05-09', 10, true, 'Bil i ok tilstand, ingen større skader');

INSERT INTO condition_report(fk_vehicle_id, handled_by, report_start_date)
VALUES (4, 'JÜHIN', '2025-05-10');
...
VALUES (1, 1, 'Ridse på venstre dør', 500.00),
